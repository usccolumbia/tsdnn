...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Neighbor Information Preloader of Crystal Graph Convolutional Neural Networks')
    parser.add_argument('--cifs', type=str,
                        help='Root directory where .cif files exist')
    ...
    parser.add_argument('--dmin', type=float, default=0,
                        help='The minimum distance for constructing GaussianDistance')
    parser.add_argument('--s', type=float, default=0.2,
                        help='The step size for constructing GaussianDistance')
    parser.add_argument(
        '--f', type=str, help='Folder name for saving crystal graph (.pickle files)')
    parser.add_argument('--dataset', type=str,
                        default='dataset.csv', help='dataset.csv file')
