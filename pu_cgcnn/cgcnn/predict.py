...
def main(iteration):
    ...
    # load data
    dataset = CIFData(args.cifpath, iteration=iteration, train=False)
    ...
    return validate(test_loader, model, criterion, normalizer, iteration, test=True)
